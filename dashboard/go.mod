module github.com/gaullow/goflow/dashboard
...
require (
	...
	github.com/gaullow/goflow v0.1.5-0.20230622121947-e28fb2fe6482
...
require (
	...
	github.com/open-telemetry/opentelemetry-go v1.2.0 // indirect
